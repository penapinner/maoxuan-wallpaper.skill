...
- **100 条精选语录** — 覆盖《毛选》四卷 + 文集 + 诗词，每日随机轮换
- **书法艺术字** — 汉仪黄科行书简，朱砂红渐变，如毛笔挥就
- **羊皮纸古风** — 暖色底纹 + 纸纹质感 + 暖金光晕
- **毛选印章** — 右上角「毛选」朱砂印，左下角竖排年份
- **详细出处** — 每句标注卷次、篇名、日期、段落注释
- **跨平台** — Windows / macOS / Linux 一键设为桌面壁纸
...
├── README.md            ← 本文件
├── preview.png          ← 预览图
├── .gitignore           ← 忽略 *.png（保留 preview.png）
